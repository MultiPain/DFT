...
#define NOTIFY_MAX_MSG_LENGTH			2048		// Max message content length
#define NOTIFY_PADDING_X				20.f		// Bottom-left X padding
#define NOTIFY_PADDING_Y				20.f		// Bottom-left Y padding
#define NOTIFY_PADDING_MESSAGE_Y		10.f		// Padding Y between each message
#define NOTIFY_FADE_IN_OUT_TIME			0.15f		// Fade in and out duration
#define NOTIFY_DEFAULT_DISMISS			3.0f		// Auto dismiss after X s (default, applied only of no data provided in constructors)
...
public:
	...
	NOTIFY_INLINE auto get_elapsed_time() { return ImGui::GetTime() - this->creation_time; }
...
namespace ImGui
{
	...
	NOTIFY_INLINE void RenderNotifications()
	{
		...
		const auto vp_size = ImGui::GetIO().DisplaySize;
